...
export default function StaffManagement({ auth }) {
    ...
    return (
                ...
                <div className="flex w-full">
                    {['all', 'doctors', 'nurses', 'admins'].map((tab) => (
                        <button 
                            ...
                            className={`flex-1 py-2 text-center transition-colors font-bold uppercase text-xs tracking-wider ${
                                activeTab === tab 
        ...
        >
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 min-h-[600px] p-8">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-xl font-medium text-slate-700">Staff List</h2>
                    <button className="bg-[#5A9167] hover:bg-[#4a7a55] text-white px-4 py-2 rounded font-bold text-xs shadow-sm transition-colors uppercase">
                        + ADD NEW STAFF
                    </button>
                </div>
