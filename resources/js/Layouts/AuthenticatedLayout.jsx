...
export default function AuthenticatedLayout({ children, header, sectionTitle }) {
    ...
    const navigation = {
        ...
        Doctor: [
            ...
            { name: 'Profile', routeName: 'doctor.profile', href: route('doctor.profile'), icon: staffIcon },
        ],
        Nurse: [
            ...
            { name: 'Profile', routeName: 'nurse.profile', href: route('nurse.profile'), icon: staffIcon },
        ],
    };
                    ...
                    <div className="flex flex-col gap-2">
                        <Link href={getProfileRoute()} className="flex items-center gap-3 hover:bg-white/10 p-2 -ml-2 rounded-lg transition-colors group">
                            ...
                            <div className="overflow-hidden text-white">
                                <p className="text-sm font-bold truncate leading-none mb-0.5 group-hover:text-blue-200">{auth.user.first_name} {auth.user.last_name}</p>
