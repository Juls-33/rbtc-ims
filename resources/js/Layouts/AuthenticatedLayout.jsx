...
export default function AuthenticatedLayout({ children, header, sectionTitle }) {
    ...
    const roomIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#EFEFEF">
            <path d="M160-200v-440l320-240 320 240v440H160Zm80-80h110v-160h180v160h110v-326L480-738 240-526v246Zm250-160h-20v20h20v-20Zm-100 0h-20v20h20v-20Zm200 0h-20v20h20v-20Z"/>
        </svg>
    );
    const logoutIcon = (
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#EFEFEF">
